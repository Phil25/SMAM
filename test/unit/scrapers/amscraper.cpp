...
{
    expected.nameToLink["afk_manager_old.zip"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=dc5547938c38333b03dff89b0ac17723&"
        "attachmentid=160240&d=1484963606";

    expected.nameToLink["afk_manager.phrases.txt"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=dc5547938c38333b03dff89b0ac17723&"
        "attachmentid=166646&d=1510967008";

    expected.nameToLink["afk_manager.inc"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=dc5547938c38333b03dff89b0ac17723&"
        "attachmentid=168028&d=1516358726";

    expected.nameToLink["afk_manager4.smx"] =
        "http://www.sourcemod.net/vbcompiler.php?file_id=170330";

    expected.nameToLink["afk_manager4.sp"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=dc5547938c38333b03dff89b0ac17723&"
        "attachmentid=170330&d=1530622367";

    expected.nameToLink["afk_manager.changelog.txt"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=dc5547938c38333b03dff89b0ac17723&"
...
{
    expected.nameToLink["dynamic_motd.smx"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=a59969c161c4e0ac23ef19c7cbb9ee5e&"
        "attachmentid=160284&d=1485099001";

    expected.nameToLink["dynamic_motd.sp"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=a59969c161c4e0ac23ef19c7cbb9ee5e&"
...
{
    expected.nameToLink["funcommandsX_2.5.zip"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=dc5547938c38333b03dff89b0ac17723&"
...
{
    expected.nameToLink["thriller.plugin.txt"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=a59969c161c4e0ac23ef19c7cbb9ee5e&"
        "attachmentid=133555&d=1400274898";

    expected.nameToLink["thriller.smx"] =
        "http://www.sourcemod.net/vbcompiler.php?file_id=128466";

    expected.nameToLink["thriller.sp"] =
        "https://forums.alliedmods.net/"
        "attachment.php?s=a59969c161c4e0ac23ef19c7cbb9ee5e&"
