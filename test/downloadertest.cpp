...
{
    auto result = down.html("https://builds.limetech.io/?p=tf2items",
                            "</h2>", "</div>");
    EXPECT_EQ(10138, result.size()) << "Bad size";

    result = down.html("https://builds.limetech.io/?p=tf2items",
                       "<head>", "</head>");
    EXPECT_EQ(
...
{
    ASSERT_TRUE(down.file("https://builds.limetech.io/files/"
...
{
    ASSERT_TRUE(down.file("http://www.sourcemod.net/"
    ...
    ASSERT_TRUE(
        down.file("https://forums.alliedmods.net/"
...
{
    ASSERT_TRUE(
        down.file("https://github.com/FlaminSarge/tf2attributes/"
    ...
    ASSERT_TRUE(
        down.file("https://raw.githubusercontent.com/FlaminSarge/"
